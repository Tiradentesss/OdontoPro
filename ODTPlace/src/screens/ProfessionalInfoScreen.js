      ...
      <SafeAreaView style={[styles.container, { backgroundColor: isDarkMode ? colors.container : 'transparent' }]}> 
        ...
        <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.85}
            onPress={() => navigation.navigate('AppointmentBooking', { professional, clinic, user, selectedSpecialty: route?.params?.selectedSpecialty, selectedSpecialtyId: route?.params?.selectedSpecialtyId, selectedSpecialtyPrice: route?.params?.selectedSpecialtyPrice, specialtyCatalog: route?.params?.specialtyCatalog })}
          >
