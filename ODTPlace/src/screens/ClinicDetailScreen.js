                        ...
                        <View style={styles.serviceGrid}>
                            {visibleServices.map((service) => (
                                <TouchableOpacity
                                    ...
                                    activeOpacity={0.85}
                                    onPress={() => navigation.navigate('Professionals', { clinic, user, selectedSpecialty: service.name, selectedSpecialtyId: service.id, selectedSpecialtyPrice: service.price, specialtyCatalog: specialties })}
                                >
