...
export default function ProfessionalsScreen({ route, navigation }) {
    ...
    const specialtyCatalog = route?.params?.specialtyCatalog ?? [];
                        ...
                        renderItem={({ item }) => {
                            ...
                            return (
                                <TouchableOpacity
                                    ...
                                    activeOpacity={0.86}
                                    onPress={() => navigation.navigate('ProfessionalInfo', { professional: item, clinic, user, selectedSpecialty: activeSpecialty, selectedSpecialtyId, selectedSpecialtyPrice, specialtyCatalog })}
                                >
